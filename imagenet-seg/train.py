...
class Data(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image            = cv2.imread('/GPUFS/nsccgz_ywang_zfd/ImageNet/train/ILSVRC2012_img_train/data'+'/train/'+name)
...
if __name__=='__main__':
    ...
    parser.add_argument('--datapath'    ,default='/GPUFS/nsccgz_ywang_zfd/caoxz/data/spol/imagenet')
    parser.add_argument('--savepath'    ,default='./out')
    parser.add_argument('--mode'        ,default='train')
    parser.add_argument('--list'        ,default='../dataset/ImageNet2012/train.txt')
