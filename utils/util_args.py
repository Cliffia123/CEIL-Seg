...
def get_args():
    ...
    parser.add_argument('--is_pca',type=str2bool, default=False)
    ...
    parser.add_argument('--is_train', type=str2bool, default=True, help='is_train')
    parser.add_argument('--mode', type=str, default='compo', help='is_train')
    parser.add_argument('--mode_eva', type=str, default='eva', help='is_eva')
    ...
    if args.dataset == 'CUB':
        ...
        args.json_root = 'datalist/CUB/json_cub'
        args.first_compo = 'first_compo_CUB.json'
        args.pca_maps = 'pca_maps_CUB.json'
        args.pca_batch_size = 25

    elif args.dataset == 'ILSVRC':
        args.data_list = 'datalist/ILSVRC'
        args.json_root = '/data0/caoxz/EIL/ilsvrc_eil_geometric/datalist/ILSVRC/json_cub'
        args.first_compo = 'first_compo_ILSVRC.json'
        args.pca_maps = 'pca_maps_ILSVRC.json'
        args.pca_batch_size = 25
    return args
